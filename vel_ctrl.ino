...
void velCtrlExecute() {
  ...
  distanceGet(&dist_curr_l, &dist_curr_r);
...
void velCtrlSet(double vel_l, double vel_r) {
  vel_ref_l = vel_l;
  vel_ref_r = vel_r;
}

void velCtrlGet(double *vel_l, double *vel_r) {
  *vel_l = vel_curr_l;
  *vel_r = vel_curr_r;
}

void velCtrlGet_vari(double *variance) {
  *variance = varian;
}
